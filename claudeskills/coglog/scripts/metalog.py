...
Usage as CLI:
    ...
    python3 metalog.py write < input.json
    python3 metalog.py clear
...
def main():
    ...
    if command == "read":
        ...
        print("""usage: metalog.py <read|write|clear>
...
if __name__ == "__main__":
    try:
        ...
        print(f"metalog error: invalid JSON: {e}", file=sys.stderr)
        sys.exit(1)
